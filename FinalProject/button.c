...
// masks to use for bitwise operations
#define BIT0 = 0x01
#define BIT1 = 0x02
#define BIT2 = 0x04
#define BIT3 = 0x08
...
// why did it throw errors when i passed in BIT4 instead of 0x10
/**
...
void button_init() {
  ...
  // Instead, use the PRGPIO register and busy-wait on the peripheral ready bit for PORTE.
	...
	// input is enabled as a 0 and output is enabled as a 1
	GPIO_PORTE_DIR_R &= ~0x0F; // enable pins 0-3 as inputs same as 0xFFFFFFF0
...
uint8_t button_getButton() {
	...
	// operation order is integral here since 4 is the right most button we check the buttons in order form 1-4
